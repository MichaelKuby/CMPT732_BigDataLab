...
def main(data_directory, output_directory):
    ...
    assembler = VectorAssembler(inputCols=['DOTY', 'latitude', 'longitude', 'elevation', 'yesterday_tmax'], outputCol='features')
...
if __name__ == '__main__':
    ...
    spark = SparkSession.builder.appName('weather tomorrow train').getOrCreate()
