...
COPY amenities FROM 's3://sfu-cmpt-732-redshift/amenities/'
IAM_ROLE 'arn:aws:iam::585606100982:role/RedshiftS3Full'
FORMAT JSON 'auto';
...
COPY customers FROM 's3://sfu-cmpt-732-redshift/customers/'
IAM_ROLE 'arn:aws:iam::585606100982:role/RedshiftS3Full'
FORMAT AS CSV;
...
COPY paymentmethods FROM 's3://sfu-cmpt-732-redshift/paymentmethods/'
IAM_ROLE 'arn:aws:iam::585606100982:role/RedshiftS3Full'
FORMAT AS CSV;
...
COPY purchases FROM 's3://sfu-cmpt-732-redshift/purchases/'
IAM_ROLE 'arn:aws:iam::585606100982:role/RedshiftS3Full'
FORMAT AS CSV;
...
COPY greater_vancouver_prefixes FROM 's3://sfu-cmpt-732-redshift/redshift-tables/greater_vancouver_prefixes.csv'
IAM_ROLE 'arn:aws:iam::585606100982:role/RedshiftS3Full'
FORMAT AS CSV;
...
STORED AS TEXTFILE
LOCATION 's3://sfu-cmpt-732-redshift/ext-purchases/';
...
LOCATION 's3://sfu-cmpt-732-redshift/amenities/';
